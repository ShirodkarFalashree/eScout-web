...
const SearchPage = () => {
  ...
  <div className="bg-white bg-opacity-0 bg-blur-lg p-4 rounded-3xl top shadow-lg h-64 justify-end absolute -bottom-48 left-1/2 transform -translate-x-1/2 mb-8 z-10 ">
